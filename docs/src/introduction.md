...
It provides a capability-based plugin registry and router, an append-only provenance ledger, and a plugin SDK for building first- and third-party extensions. The REST API is the universal interface surface.
...
- **Architecture** — how the system is structured, how capabilities and plugins work, and how storage migrations are handled
